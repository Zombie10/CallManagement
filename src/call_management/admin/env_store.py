...
SETTING_SECTIONS: dict[str, list[dict[str, Any]]] = {
    ...
    "xai_models": [
        ...
        {
            "key": "GROK_VOICE_IDLE_TIMEOUT_MS",
            "label": "Idle re-engage (ms)",
            "type": "number",
            "hint": "Tras responder, re-engancha si el usuario no habla. 0 = desactivado. Default 10000.",
        },
        {
            "key": "GROK_VOICE_KEYTERMS",
            "label": "ASR keyterms",
            "type": "text",
            "hint": "Términos de dominio (coma-separados) para mejorar transcripción. Máx 100.",
        },
        {
            "key": "GROK_VOICE_REPLACE",
            "label": "Pronunciation replace (JSON)",
            "type": "json",
            "hint": 'Mapa {"Acme Mobile":"Acme Mobull"} — corrige audio sin cambiar el transcript.',
        },
        {
            "key": "GROK_VOICE_OUTPUT_SPEED",
            "label": "Output speech speed",
            "type": "text",
            "hint": "0.7–1.5 (default 1.0).",
        },
        {
            "key": "GROK_VOICE_RESUMPTION",
            "label": "Session resumption",
            "type": "boolean",
            "hint": "Cachea turns en xAI para reconectar con contexto (30 min).",
        },
        {
            "key": "GROK_VOICE_RECORDING_DISCLOSURE",
            "label": "Recording disclosure",
            "type": "text",
            "hint": 'force_message al conectar, p.ej. "Esta llamada está siendo grabada."',
        },
